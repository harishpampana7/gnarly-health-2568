// main div1
    ...
    heading.innerText="India will have e-passports soon: MEA"

    para = document.createElement("p")
    para.innerText="ANI | DECCAN CHRONICLE"
    para.innerText="PublishedAug 24, 2022, 12:05 am IST"
    para.innerText="UpdatedAug 24, 2022, 6:36 am IST"

    var image1 = document.createElement("img")
    image1.src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-lgg7gaun0mhh84lo2k2dh8tu24-20220824212803.Medi.jpeg";
    parax = document.createElement("p")
    parax.innerText="Dr. Ausaf Sayeed, Secretary (CPV & OIA), Ministry of External Affairs briefs media about the latest initiatives of Ministry of External Affairs at the Regional Passport Office in Secunderabad. (DC Image/Durga Rao)"
    ...
    para2.innerText="The reports were submitted in three parts, two were of the technical committee and one report of the overseeing committee by a retired judge of the Supreme Court Justice RV Raveendran, said the Supreme Court."
    para2.style.fontSize="22px";
    para3 = document.createElement("p")
    para3.innerText="Meanwhile, the technical committee said that the reports submitted, contained information about malware, information on public research material, and material extracted from private mobile instruments which are confidential and are not for public distribution."
    ...
    topstories.append(heading,para,para,image1,parax,para1,para2,para3,para4,para5,para6,para7,para8,para9,para10,para11)
