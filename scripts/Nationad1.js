// main div1
    ...
    topstories.innerText= "NATION, POLITICS"
    heading = document.createElement("h1")
    heading.innerText="CBI raids RJD MLA over land for railways jobs case on day of Nitish floor test"
    ...
    image1.src="https://s3.ap-southeast-1.amazonaws.com/images.deccanchronicle.com/dc-Cover-besd8bq2veesvv0ria28ku3gd3-20220824101701.jpeg";
    para.innerText=" Central Bureau of Investigation (CBI) "
    para1 = document.createElement("p")
    para1.innerText="Raids by a central agency are underway at the residence of RJD MLC Sunil Singh in Patna. (ANI) CBI raids RJD MLA over land for railways jobs case on day of Nitish floor test Separately, searches were conducted by the Central Bureau of Investigation today at multiple locations in Bihar and Ranchi in"
    para1.style.fontSize="25px";
    para2 = document.createElement("p")
    para2.innerText="Mr Azad claimed that the Congress had conceded its political space to the BJP and regional parties “because the leadership in the past eight years has tried to foist a non-serious individual” at the helm of the party. He was also a key member of the G-23 change-seekers’ group who had written a letter to the Congress president in 2020 seeking sweeping changes in the party. He said after the letter he had been humiliated, attacked and vilified. Even a mock funeral was taken out in Jammu. Mr Azad also mentioned that the house of a former Congress leader, Kapil Sibal, who was also a part of the G-23 grouping, was also attacked by Congress workers but the leadership kept mum."
